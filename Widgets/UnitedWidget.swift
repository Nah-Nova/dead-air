...
public struct Value {
    ...
    public var color: Color = Color(nsColor: Brand.stateLive)
}
...
public struct Provider: TimelineProvider {
    ...
    private let userDefaults: UserDefaults? = UserDefaults(suiteName: Module.widgetSuiteName)
...
public struct UnitedWidget: Widget {
    ...
    public var body: some WidgetConfiguration {
        ...
        .configurationDisplayName("Dead Air")
