...
public class Portal: PortalWrapper {
    ...
    private var systemColor: NSColor {
        SColor.fromString(Store.shared.string(key: "\(self.name)_systemColor", defaultValue: SColor.oxide.key)).additional as! NSColor
    }
    private var userColor: NSColor {
        SColor.fromString(Store.shared.string(key: "\(self.name)_userColor", defaultValue: SColor.signalTeal.key)).additional as! NSColor
    }
    ...
    private var eCoresColor: NSColor {
        SColor.fromString(Store.shared.string(key: "\(self.name)_eCoresColor", defaultValue: SColor.signalTeal.key)).additional as! NSColor
    }
    private var pCoresColor: NSColor {
        SColor.fromString(Store.shared.string(key: "\(self.name)_pCoresColor", defaultValue: SColor.oxide.key)).additional as! NSColor
    }
    private var sCoresColor: NSColor {
        SColor.fromString(Store.shared.string(key: "\(self.name)_sCoresColor", defaultValue: SColor.tallyAmber.key)).additional as! NSColor
    }
