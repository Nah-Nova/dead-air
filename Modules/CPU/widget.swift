...
public struct Provider: TimelineProvider {
    ...
    private let userDefaults: UserDefaults? = UserDefaults(suiteName: "\(Bundle.main.object(forInfoDictionaryKey: "TeamId") as! String).nu.soep.deadair.widgets")
...
public struct CPUWidget: Widget {
    var systemColor: Color = Color(nsColor: Brand.stateDead)
    var userColor: Color = Color(nsColor: Brand.stateLive)
    var idleColor: Color = Color(nsColor: Brand.legendSecondary)
