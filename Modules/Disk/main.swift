...
public class Disks: Codable, RemoteType {
    private var queue: DispatchQueue = DispatchQueue(label: "nu.soep.deadair.Disk.SynchronizedArray")
...
public class Disk: Module {
    ...
    private var mainColor: NSColor {
        SColor.fromString(Store.shared.string(key: "\(self.name)_mainColor", defaultValue: SColor.signalTeal.key)).additional as! NSColor
    }
