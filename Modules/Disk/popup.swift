...
internal class Popup: PopupWrapper {
    private var mainColorState: SColor = .signalTeal
    private var mainColor: NSColor { self.mainColorState.additional as? NSColor ?? Brand.stateLive }
...
internal class DiskView: NSStackView {
    ...
    private var mainColor: NSColor {
        SColor.fromString(Store.shared.string(key: "\(ModuleType.disk.stringValue)_mainColor", defaultValue: SColor.signalTeal.key)).additional as! NSColor
    }
...
internal class ChartView: NSStackView {
    ...
    private var readColor: NSColor {
        SColor.fromString(Store.shared.string(key: "\(ModuleType.disk.stringValue)_readColor", defaultValue: SColor.signalTeal.key)).additional as! NSColor
    }
    private var writeColor: NSColor {
        SColor.fromString(Store.shared.string(key: "\(ModuleType.disk.stringValue)_writeColor", defaultValue: SColor.oxide.key)).additional as! NSColor
    }
    private var base: DataSizeBase {
