...
public class Portal: PortalWrapper {
    ...
    private var valueColor: NSColor {
        SColor.fromString(Store.shared.string(key: "\(self.name)_valueColor", defaultValue: SColor.signalTeal.key)).additional as! NSColor
    }
    private var readColor: NSColor {
        SColor.fromString(Store.shared.string(key: "\(self.name)_readColor", defaultValue: SColor.signalTeal.key)).additional as! NSColor
    }
    private var writeColor: NSColor {
        SColor.fromString(Store.shared.string(key: "\(self.name)_writeColor", defaultValue: SColor.oxide.key)).additional as! NSColor
    }
