...
public struct Clock_t: Codable {
    ...
    private static let formattersQueue = DispatchQueue(label: "nu.soep.deadair.Clock.formatters")
...
public class Clock: Module {
    ...
    private static let listQueue = DispatchQueue(label: "nu.soep.deadair.Clock.list")
