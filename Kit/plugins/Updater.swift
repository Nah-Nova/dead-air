...
public class Updater {
    ...
    public func install(path: String, completion: @escaping (_ error: String?) -> Void) {
        ...
        let mountedApp = (mountPoint as NSString).appendingPathComponent("Dead Air.app")
    ...
    private func makeUniqueMountPoint() throws -> String {
        let template = (NSTemporaryDirectory() as NSString).appendingPathComponent("DeadAir-update-XXXXXX")
