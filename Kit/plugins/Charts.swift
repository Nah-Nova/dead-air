...
public class LineChartView: ChartView {
    ...
    public init(
        ...
        super.init(frame: frame, queueLabel: "nu.soep.deadair.Charts.Line")
    ...
    public override func draw(_ dirtyRect: NSRect) {
        ...
        var color: NSColor = Brand.stateLive
        var suffix: String = "%"
...
public class NetworkChartView: ChartView {
    ...
    public init(
        ...
        super.init(frame: frame, queueLabel: "nu.soep.deadair.Charts.Network")
...
public class PieChartView: ChartView {
    ...
    public init(
        ...
        super.init(frame: frame, queueLabel: "nu.soep.deadair.Charts.Pie")
        self.animationEnabled = animation
...
public class TachometerGraphView: ChartView {
    ...
    public init(frame: NSRect = .zero, segments: [ColorValue], filled: Bool = true, animation: Bool = true) {
        ...
        super.init(frame: frame, queueLabel: "nu.soep.deadair.Charts.Tachometer")
        self.animationEnabled = animation
    }
...
public class GaugeChartView: ChartView {
    ...
    public init(frame: NSRect = .zero, segments: [ColorValue], title: String? = nil, animation: Bool = true) {
        ...
        super.init(frame: frame, queueLabel: "nu.soep.deadair.Charts.Gauge")
        self.animationEnabled = animation
...
public class ColumnChartView: ChartView {
    ...
    public init(frame: NSRect = NSRect.zero, num: Int, animation: Bool = true) {
        super.init(frame: frame, queueLabel: "nu.soep.deadair.Charts.Column")
        self.animationEnabled = animation
        self.values = Array(repeating: ColorValue(0, color: Brand.stateLive), count: num)
    ...
    public override func draw(_ dirtyRect: NSRect) {
        ...
        for i in 0..<values.count {
            ...
            let value = values[i]
            let color = value.color ?? Brand.stateLive
...
public class GridChartView: ChartView {
    ...
    public init(frame: NSRect = .zero, grid: (rows: Int, columns: Int)) {
        self.grid = grid
        super.init(frame: frame, queueLabel: "nu.soep.deadair.Charts.Grid")
...
public class BarChartView: ChartView {
    ...
    public init(frame: NSRect = NSRect.zero, size: CGFloat? = nil, horizontal: Bool = false, animation: Bool = true) {
        ...
        super.init(frame: frame, queueLabel: "nu.soep.deadair.Charts.Bar")
        self.animationEnabled = animation
    }
