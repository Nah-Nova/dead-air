...
public enum widget_t: String {
    ...
    public func new(module: String, config: NSDictionary, defaultWidget: widget_t) -> SWidget? {
        ...
        case .mark:
            preview = MarkWidget(title: module, config: widgetConfig, preview: true)
            item = MarkWidget(title: module, config: widgetConfig, preview: false)
        case .tachometer:
    ...
    public func name() -> String {
        ...
        case .mark: return localizedString("Mark widget")
        default: return ""
        }
    }
}
...
open class WidgetWrapper: NSView, widget_p {
    ...
    public init(_ type: widget_t, title: String, frame: NSRect) {
        ...
        self.queue = DispatchQueue(label: "nu.soep.deadair.WidgetWrapper.\(type.rawValue).\(title)")
...
public class MenuBar {
    ...
    init(moduleName: String) {
        ...
        self.queue = DispatchQueue(label: "nu.soep.deadair.MenuBar.\(moduleName)")
