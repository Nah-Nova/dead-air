...
open class Reader<T: Codable>: NSObject, ReaderInternal_p {
    ...
    private let valueQueue = DispatchQueue(label: "nu.soep.deadair.readerActiveQueue")
    ...
    private let activeQueue = DispatchQueue(label: "nu.soep.deadair.readerActiveQueue")
    ...
    private let alignQueue = DispatchQueue(label: "nu.soep.deadair.readerAlignQueue")
