...
internal class PopupView: NSView {
    ...
    init(frame: NSRect, module: ModuleType) {
        ...
        self.foreground.layer?.backgroundColor = Brand.groundApp.cgColor
    ...
    override func updateLayer() {
        self.background.layer?.backgroundColor = Brand.groundApp.cgColor
    }
...
internal class HeaderView: NSStackView {
    ...
    init(frame: NSRect, module: ModuleType) {
        ...
        title.textColor = Brand.legendPrimary
        title.backgroundColor = .clear
        title.canDrawSubviewsIntoLayer = true
        title.alignment = .center
        title.font = Brand.Font.body(size: 13, weight: .semibold)
        title.stringValue = ""
