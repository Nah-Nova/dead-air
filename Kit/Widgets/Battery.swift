...
public class BatteryWidget: WidgetWrapper {
    ...
    public override func draw(_ dirtyRect: NSRect) {
        ...
        Brand.legendPrimary.withAlphaComponent(0.5).set()
        ...
        if let percentage {
            ...
            if innerPercentage {
                ...
                (self.colorState ? color : Brand.legendPrimary).withAlphaComponent(0.5).set()
            ...
            if innerPercentage {
                ...
                let attributes = [
                    NSAttributedString.Key.font: Brand.Font.utility(size: fontSize, weight: .bold),
            ...
            let attributes = [
                NSAttributedString.Key.font: Brand.Font.utility(size: 11, weight: .regular),
                NSAttributedString.Key.foregroundColor: Brand.legendPrimary,
    ...
    private func drawOneRow(value: String, x: CGFloat) -> CGFloat {
        let attributes = [
            NSAttributedString.Key.font: Brand.Font.utility(size: 12, weight: .regular),
            NSAttributedString.Key.foregroundColor: Brand.legendPrimary,
            NSAttributedString.Key.paragraphStyle: NSMutableParagraphStyle()
        ]
        
        let rowWidth = value.widthOfString(usingFont: Brand.Font.utility(size: 12, weight: .regular))
    ...
    private func drawTwoRows(first: String, second: String, x: CGFloat) -> CGFloat {
        ...
        style.alignment = .center
        let attributes = [
            NSAttributedString.Key.font: Brand.Font.utility(size: 9, weight: .regular),
            NSAttributedString.Key.foregroundColor: Brand.legendPrimary,
            NSAttributedString.Key.paragraphStyle: style
        ]
        ...
        let rowWidth = max(
            first.widthOfString(usingFont: Brand.Font.utility(size: 9, weight: .regular)),
            second.widthOfString(usingFont: Brand.Font.utility(size: 9, weight: .regular))
        )
