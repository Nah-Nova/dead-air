...
public class LineChart: WidgetWrapper {
    ...
    private var colorState: SColor = .signalTeal
    ...
    public init(title: String, config: NSDictionary?, preview: Bool = false) {
        ...
        let stringAttributes = [
            NSAttributedString.Key.font: Brand.Font.utility(size: 7, weight: .regular),
    ...
    public override func draw(_ dirtyRect: NSRect) {
        ...
        default: color = self.colorState.additional as? NSColor ?? Brand.stateLive
        }
        ...
        if self.valueState {
            ...
            var valueColor = Brand.legendPrimary
            if self.valueColorState {
                switch self.colorState {
                case .utilization: valueColor = value.usageInk()
                case .pressure: valueColor = pressureLevel.pressureInk()
                default: valueColor = color
                }
            }

            let stringAttributes = [
                NSAttributedString.Key.font: Brand.Font.utility(size: 8, weight: .regular),
