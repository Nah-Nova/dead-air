    ...
    public override func draw(_ dirtyRect: NSRect) {
        ...
        if self.labelState {
            ...
            let stringAttributes = [
                NSAttributedString.Key.font: Brand.Font.utility(size: 7, weight: .light),
        ...
        case .utilization: color = value.usageInk(zones: colorZones, reversed: self.title == "BAT")
        case .pressure: color = pressureLevel.pressureInk()
        ...
        let stringAttributes = [
            NSAttributedString.Key.font: Brand.Font.utility(size: valueSize, weight: .regular),
