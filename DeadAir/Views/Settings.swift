...
class SettingsWindow: NSWindow, NSWindowDelegate, NSToolbarDelegate {
    ...
    private static let frameAutosaveName = "nu.soep.deadair.Settings.WindowFrame"
    ...
    init() {
        ...
        let newToolbar = NSToolbar(identifier: "nu.soep.deadair.Settings.Toolbar")
...
private class SidebarView: NSStackView {
    ...
    @objc private func reportBug() {
        NSWorkspace.shared.open(URL(string: "https://github.com/Nah-Nova/dead-air/issues/new")!)
    }
