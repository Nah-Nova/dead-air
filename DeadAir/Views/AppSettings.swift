...
class ApplicationSettings: NSStackView {
    ...
    private var systemWidgetsUpdatesState: Bool {
        get {
            let userDefaults = UserDefaults(suiteName: "\(Bundle.main.object(forInfoDictionaryKey: "TeamId") as! String).nu.soep.deadair.widgets")
    ...
    private func informationView() -> NSView {
        ...
        statsName.font = Brand.Font.display(size: 22)
        statsName.stringValue = "Dead Air"
    ...
    @objc private func exportSettings() {
        ...
        panel.nameFieldStringValue = "DeadAir.plist"
